...
function init() {
    ...
    $(".btn-default").css({"background-color": "#eeeeee"});
}
...
function refreshScreen() {
    ...
    for (var joueur in tabScore) {
        ...
        Object.keys(dict).forEach(function(key) {
            switch (dict[key]) {
                case 0:
                    $("#" + key + "_" + joueur).children().attr("src", "/images/0.svg");
                    break;
                case 1:
                    $("#" + key + "_" + joueur).children().attr("src", "/images/1.svg");
                    break;
                case 2:
                    $("#" + key + "_" + joueur).children().attr("src", "/images/2.svg");
                    break;
                case 3:
                    $("#" + key + "_" + joueur).children().attr("src", "/images/3.svg");
                    break;
                default:
                    //
            }
        ...
        $('#' + joueur).text(score);
        $("." + joueur).css({"background-color": "#eeeeee"});
        $("." + joueur + " button").css({"background-color": "#eeeeee"});
    }
    ...
    $(".Joueur_" + currentPlayer[currentPlayer.length-1]).css({"background-color": "#FF8800"});
    $(".Joueur_" + currentPlayer[currentPlayer.length-1] + " button").css({"background-color": "#FF8800"});
}
...
function griserLigne(idRow) {
    ...
    if (griser) {
        ...
        $(".Ligne_" + idRow).css({"background-color":"black"});
    }
}